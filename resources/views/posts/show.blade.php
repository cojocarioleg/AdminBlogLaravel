    ...
    <div class="blog-title-area">
        <ol class="breadcrumb hidden-xs-down">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('showPostCategory', ['slug'=>$post->category->slug]) }}">
        ...
        <span class="color-yellow">
            <a href="{{ route('showPostCategory', ['slug'=>$post->category->slug]) }}" title="{{ $post->category->slug }}">
                {{ $post->category->title}}</a>
        </span>
        ...
        @if ($post->tags->count())
            <div class="tag-cloud-single">
                ...
                @foreach ($post->tags as $tag )
                    <small><a href="{{ route('showPostTag', ['slug'=>$tag->slug]) }}" title="">{{ $tag->title }}</a></small>
                @endforeach
